...
import com.fastcampus03.calendarbe.core.auth.jwt.MyJwtAuthorizationFilter;
import com.fastcampus03.calendarbe.core.exception.Exception401;
import com.fastcampus03.calendarbe.core.exception.Exception403;
import com.fastcampus03.calendarbe.core.util.MyFilterResponseUtil;
...
public class MySecurityConfig {
    ...
    public CorsConfigurationSource configurationSource() {
        ...
        configuration.addAllowedMethod(HttpMethod.POST); // GET, POST, PUT, DELETE (Javascript 요청 허용)
