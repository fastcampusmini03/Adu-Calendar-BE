package com.fastcampus03.calendarbe.core.advice;
...
public class MyLogAdvice {
    ...
    @Pointcut("@annotation(com.fastcampus03.calendarbe.core.annotation.MyLog)")
    public void myLog(){}

    @Pointcut("@annotation(com.fastcampus03.calendarbe.core.annotation.MyErrorLog)")
